// ANI2012A18_ShapesAnimation.pde
// Animation générative à partir de différentes primitives vectorielles.
...
void drawPoint()
{
  // un point est dessiné comme une ligne de conteur sans zone de remplissage
  stroke(colorStroke);
...
void drawLine()
{
  // une ligne est dessinée comme une ligne de conteur sans zone de remplissage
  stroke(colorStroke);
